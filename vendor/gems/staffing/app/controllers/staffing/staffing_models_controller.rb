...
#module Staffing
  class Staffing::StaffingModelsController < ApplicationController
    ...
    def show
      ...
      set_breadcrumbs I18n.t(:organizations) => "/organizationals_params", I18n.t(:team_modules) => main_app.organization_module_estimation_path(@staffing_model.organization, anchor: "team"), @staffing_model.organization => ""
    end
    ...
    def new
      ...
      set_breadcrumbs I18n.t(:organizations) => "/organizationals_params", I18n.t(:team_modules) => main_app.organization_module_estimation_path(params['organization_id'], anchor: "team"), @staffing_model.organization => ""
    end
