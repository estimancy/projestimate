module Staffing
  class StaffingCustomDatum < ActiveRecord::Base
    attr_accessible :staffing_model_id, :module_project_id, :pbs_project_element_id, :mc_donell_coef, :puissance_n, :coef_a, :coef_a_prime, :coef_b, :coef_b_prime, :duration, :max_staffing, :staffing_method, :period_unit, :staffing_constraint,
