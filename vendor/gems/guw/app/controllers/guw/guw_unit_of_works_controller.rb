  ...
  def save_uo
    ...
    if guw_unit_of_work.guw_type.allow_complexity == true && guw_unit_of_work.guw_type.allow_criteria == false
      ...
      if guw_unit_of_work.guw_complexity.nil?
        ...
        @weight_pert << cwu.value * (tcplx.nil? ? 1 : tcplx.coefficient.to_f) * (guw_unit_of_work.guw_complexity.weight.nil? ? 1 : guw_unit_of_work.guw_complexity.weight.to_f)
      end
      guw_unit_of_work.save
    else
  ...
  def save_guw_unit_of_works
    ...
    @guw_unit_of_works.each_with_index do |guw_unit_of_work, i|
      ...
      if guw_unit_of_work.guw_type.allow_complexity == true
        ...
        if guw_unit_of_work.guw_complexity.nil?
          @weight_pert << (cwu.value.nil? ? 1 : cwu.value.to_f) * (tcplx.nil? ? 1 : tcplx.coefficient.to_f) * 1
        else
          @weight_pert << (cwu.value.nil? ? 1 : cwu.value.to_f) * (tcplx.nil? ? 1 : tcplx.coefficient.to_f) * (guw_unit_of_work.guw_complexity.weight.nil? ? 1 : guw_unit_of_work.guw_complexity.weight.to_f)
        end
  ...
  def calculate_seuil(guw_unit_of_work, guw_c, value_pert, guw_work_unit)
    ...
    if (guw_unit_of_work.result_low.to_i >= guw_c.bottom_range) and (guw_unit_of_work.result_low.to_i < guw_c.top_range)
      ...
      if guw_c.enable_value == false
        uo_weight_low = (cwu.value.nil? ? 1 : cwu.value.to_f) * (tcplx.nil? ? 1 : tcplx.coefficient.to_f) * (guw_c.weight.nil? ? 1 : guw_c.weight.to_f)
      else
        uo_weight_low = guw_unit_of_work.result_low.to_i * (cwu.value.nil? ? 1 : cwu.value.to_f) * (tcplx.nil? ? 1 : tcplx.coefficient.to_f) * (guw_c.weight.nil? ? 1 : guw_c.weight.to_f)
      end
    end
    ...
    if (guw_unit_of_work.result_most_likely.to_i >= guw_c.bottom_range) and (guw_unit_of_work.result_most_likely.to_i < guw_c.top_range)
      ...
      tcplx = Guw::GuwComplexityTechnology.where(guw_complexity_id: guw_c.id, organization_technology_id: guw_unit_of_work.organization_technology_id).first
      if guw_c.enable_value == false
        uo_weight_ml = (cwu.value.nil? ? 1 : cwu.value.to_f) * (tcplx.nil? ? 1 : tcplx.coefficient.to_f) * (guw_c.weight.nil? ? 1 : guw_c.weight.to_f)
      else
        uo_weight_ml = guw_unit_of_work.result_most_likely.to_i * (cwu.value.nil? ? 1 : cwu.value.to_f)  * (tcplx.nil? ? 1 : tcplx.coefficient.to_f) * (guw_c.weight.nil? ? 1 : guw_c.weight.to_f)
      end
    end
    ...
    if (guw_unit_of_work.result_high.to_i >= guw_c.bottom_range) and (guw_unit_of_work.result_high.to_i < guw_c.top_range)
      ...
      cwu = Guw::GuwComplexityWorkUnit.where(guw_complexity_id: guw_c.id, guw_work_unit_id: guw_work_unit.id).first
      if guw_c.enable_value == false
        uo_weight_high = (cwu.value.nil? ? 1 : cwu.value.to_f) * (tcplx.nil? ? 1 : tcplx.coefficient.to_f) * (guw_c.weight.nil? ? 1 : guw_c.weight.to_f)
      else
        uo_weight_high = guw_unit_of_work.result_high.to_i * (cwu.value.nil? ? 1 : cwu.value.to_f) * (tcplx.nil? ? 1 : tcplx.coefficient.to_f) * (guw_c.weight.nil? ? 1 : guw_c.weight.to_f)
      end
    end
