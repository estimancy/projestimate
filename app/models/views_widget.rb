class ViewsWidget < ActiveRecord::Base
  attr_accessible :color, :icon_class, :module_project_id, :name, :pbs_project_element_id, :pe_attribute_id, :show_min_max, :view_id, :widget_id, :position_x, :position_y, :width, :height, :widget_type
  ...
  validates :name, :pe_attribute_id, :icon_class, presence: true
