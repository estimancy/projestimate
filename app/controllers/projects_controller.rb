  ...
  def update_views_and_widgets(new_prj, old_mp, new_mp)
    ...
    ###if old_mp.pemodule.alias == Projestimate::Application::INITIALIZATION
      ...
      if old_mp.view
        ...
        new_view = View.create(organization_id: new_prj.organization_id, pemodule_id: new_mp.pemodule_id , name: "#{new_prj.to_s} :  #{old_mp.view.name}", description: "Please rename the view's name and description if needed.")
